...
const SignupPage = () => {
  ...
  return (
    <div className='h-full w-full overflow-auto bg-gradient-to-b from-[#1f2728] via-[#131618] to-[#070808]'>
      ...
      <form onSubmit={submitHandler} className='md:w-[40%] md:mt-10 bg-[#070808] space-y-5 text-white rounded-xl mx-auto flex flex-col  justify-center p-20'>
        <p className='md:text-4xl md:font-extrabold text-2xl text-center font-bold'>Sign up for free to start listening.</p>
